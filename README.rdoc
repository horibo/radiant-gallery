...
This fork will remove the dependency to attachment_fu plugin. This is work in progress. Please don't fork this repository, if You are not sure! It will be merged to Thomas Cowell's master, when work is done.
